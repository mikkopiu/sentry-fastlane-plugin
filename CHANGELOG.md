...
- Bump CLI from v2.5.2 to v2.23.1 ([#44](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/44))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2231)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.23.1)
