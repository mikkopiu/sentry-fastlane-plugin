...
- Bump CLI from v2.5.2 to v2.10.0 ([#6](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/6))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2100)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.10.0)
