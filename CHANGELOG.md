...
- Bump CLI from v2.5.2 to v2.56.1 ([#106](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/106))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2561)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.56.1)
