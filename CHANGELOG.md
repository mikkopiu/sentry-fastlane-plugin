...
- Bump CLI from v2.5.2 to v2.46.0 ([#94](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/94))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2460)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.46.0)
