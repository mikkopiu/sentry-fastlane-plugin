...
- Bump CLI from v2.5.2 to v2.38.2 ([#79](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/79))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2382)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.38.2)
