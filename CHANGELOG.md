...
- Bump CLI from v2.5.2 to v2.47.1 ([#96](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/96))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2471)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.47.1)
