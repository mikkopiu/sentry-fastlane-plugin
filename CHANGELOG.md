...
- Bump CLI from v2.5.2 to v2.21.1 ([#36](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/36))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2211)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.21.1)
