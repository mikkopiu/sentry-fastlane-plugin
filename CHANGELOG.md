...
- Bump CLI from v2.5.2 to v2.28.0 ([#52](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/52))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2280)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.28.0)
