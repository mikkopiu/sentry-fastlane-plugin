...
- Bump CLI from v2.5.2 to v2.36.5 ([#74](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/74))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2365)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.36.5)
