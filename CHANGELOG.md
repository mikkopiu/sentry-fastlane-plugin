...
- Bump CLI from v2.5.2 to v2.53.0 ([#102](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/102))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2530)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.53.0)
