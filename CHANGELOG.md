...
- Bump CLI from v2.5.2 to v2.36.0 ([#69](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/69))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2360)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.36.0)
