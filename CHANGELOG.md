...
- Bump CLI from v2.5.2 to v2.44.0 ([#92](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/92))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2440)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.44.0)
