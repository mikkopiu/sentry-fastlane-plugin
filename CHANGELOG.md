...
- Bump CLI from v2.5.2 to v2.54.0 ([#103](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/103))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2540)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.54.0)
