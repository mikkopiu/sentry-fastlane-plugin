...
- Bump CLI from v2.5.2 to v3.3.2 ([#123](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/123))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#332)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.3.2)
