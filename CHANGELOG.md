...
- Bump CLI from v2.5.2 to v2.55.0 ([#104](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/104))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2550)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.55.0)
