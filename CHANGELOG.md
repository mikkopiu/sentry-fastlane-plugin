...
- Bump CLI from v2.5.2 to v3.7.0 ([#136](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/136))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#370)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.7.0)
