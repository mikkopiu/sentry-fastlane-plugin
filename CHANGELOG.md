...
- Bump CLI from v2.5.2 to v3.0.1 ([#114](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/114))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#301)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.0.1)
