...
- Bump CLI from v2.5.2 to v3.5.1 ([#132](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/132))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#351)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.5.1)
