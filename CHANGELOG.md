...
- Bump CLI from v2.5.2 to v2.30.2 ([#58](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/58))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2302)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.30.2)
