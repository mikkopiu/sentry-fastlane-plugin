...
- Bump CLI from v2.5.2 to v2.57.0 ([#107](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/107))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2570)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.57.0)
