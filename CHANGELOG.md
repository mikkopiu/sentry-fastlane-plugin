...
- Bump CLI from v2.5.2 to v2.28.6 ([#54](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/54))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2286)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.28.6)
