...
- Bump CLI from v2.5.2 to v2.31.0 ([#60](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/60))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2310)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.31.0)
