...
- Bump CLI from v2.5.2 to v2.20.1 ([#29](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/29))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2201)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.20.1)
