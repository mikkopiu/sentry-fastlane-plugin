...
- Bump CLI from v2.5.2 to v2.24.1 ([#46](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/46))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2241)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.24.1)
