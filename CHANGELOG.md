...
- Bump CLI from v2.5.2 to v2.47.0 ([#95](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/95))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2470)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.47.0)
