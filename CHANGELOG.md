...
- Bump CLI from v2.5.2 to v2.31.2 ([#62](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/62))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2312)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.31.2)
