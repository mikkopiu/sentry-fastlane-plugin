...
- Bump CLI from v2.5.2 to v3.1.0 ([#117](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/117))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#310)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.1.0)
