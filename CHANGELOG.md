...
- Bump CLI from v2.5.2 to v2.18.1 ([#23](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/23))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2181)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.18.1)
