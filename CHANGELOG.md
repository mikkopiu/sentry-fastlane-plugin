...
- Bump CLI from v2.5.2 to v3.2.1 ([#119](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/119))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#321)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.2.1)
