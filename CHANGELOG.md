...
- Bump CLI from v2.5.2 to v2.58.0 ([#108](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/108))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2580)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.58.0)
