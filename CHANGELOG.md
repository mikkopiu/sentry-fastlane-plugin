...
- Bump CLI from v2.5.2 to v2.35.0 ([#68](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/68))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2350)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.35.0)
