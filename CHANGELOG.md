...
- Bump CLI from v2.5.2 to v3.6.0 ([#133](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/133))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#360)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.6.0)
