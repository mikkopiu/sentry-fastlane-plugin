...
- Bump CLI from v2.5.2 to v2.25.2 ([#48](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/48))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2252)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.25.2)
