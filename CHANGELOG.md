...
- Bump CLI from v2.5.2 to v2.23.0 ([#43](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/43))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2230)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.23.0)
