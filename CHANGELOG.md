...
- Bump CLI from v2.5.2 to v2.18.0 ([#22](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/22))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2180)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.18.0)
