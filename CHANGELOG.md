...
- Bump CLI from v2.5.2 to v2.41.0 ([#83](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/83))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2410)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.41.0)
