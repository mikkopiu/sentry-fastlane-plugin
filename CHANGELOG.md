...
- Bump CLI from v2.5.2 to v2.39.0 ([#80](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/80))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2390)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.39.0)
