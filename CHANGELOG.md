...
- Bump CLI from v2.5.2 to v2.16.1 ([#15](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/15))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2161)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.16.1)
