...
- Bump CLI from v2.5.2 to v2.50.2 ([#98](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/98))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2502)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.50.2)
