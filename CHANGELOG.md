...
- Bump CLI from v2.5.2 to v3.3.3 ([#124](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/124))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#333)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.3.3)
