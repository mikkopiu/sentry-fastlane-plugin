...
- Bump CLI from v2.5.2 to v2.11.0 ([#7](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/7))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2110)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.11.0)
