...
- Bump CLI from v2.5.2 to v2.21.4 ([#39](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/39))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2214)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.21.4)
