...
- Bump CLI from v2.5.2 to v2.20.5 ([#32](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/32))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2205)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.20.5)
