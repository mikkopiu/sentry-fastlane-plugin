...
- Bump CLI from v2.5.2 to v3.3.0 ([#122](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/122))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#330)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.3.0)
