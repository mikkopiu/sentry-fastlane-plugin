...
- Bump CLI from v2.5.2 to v3.8.0 ([#137](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/137))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#380)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.8.0)
