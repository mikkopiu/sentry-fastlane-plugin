...
- Bump CLI from v2.5.2 to v2.16.0 ([#14](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/14))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2160)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.16.0)
