...
- Bump CLI from v2.5.2 to v2.15.1 ([#12](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/12))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2151)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.15.1)
