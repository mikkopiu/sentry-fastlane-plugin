...
- Bump CLI from v2.5.2 to v2.51.1 ([#100](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/100))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2511)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.51.1)
