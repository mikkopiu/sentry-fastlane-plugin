...
- Bump CLI from v2.5.2 to v2.42.3 ([#87](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/87))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2423)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.42.3)
