...
- Bump CLI from v2.5.2 to v2.42.5 ([#89](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/89))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2425)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.42.5)
