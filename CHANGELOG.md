...
- Bump CLI from v2.5.2 to v2.33.1 ([#66](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/66))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2331)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.33.1)
