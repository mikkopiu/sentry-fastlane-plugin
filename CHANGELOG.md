...
- Bump CLI from v2.5.2 to v2.38.0 ([#77](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/77))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2380)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.38.0)
