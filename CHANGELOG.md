...
- Bump CLI from v2.5.2 to v2.15.2 ([#13](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/13))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2152)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.15.2)
