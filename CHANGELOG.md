...
- Bump CLI from v2.5.2 to v2.45.0 ([#93](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/93))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2450)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.45.0)
