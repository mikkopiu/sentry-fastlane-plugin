...
- Bump CLI from v2.5.2 to v2.12.0 ([#8](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/8))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2120)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.12.0)
