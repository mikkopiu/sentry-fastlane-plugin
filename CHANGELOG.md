...
- Bump CLI from v2.5.2 to v2.58.4 ([#112](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/112))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2584)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.58.4)
