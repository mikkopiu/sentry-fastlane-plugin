...
- Bump CLI from v2.5.2 to v2.41.1 ([#84](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/84))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master release/test/CHANGELOG.md#2411)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.41.1)
