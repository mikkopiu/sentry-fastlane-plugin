...
- Bump CLI from v2.5.2 to v2.25.3 ([#49](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/49))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2253)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.25.3)
