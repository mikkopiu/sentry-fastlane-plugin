...
- Bump CLI from v2.5.2 to v2.30.1 ([#57](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/57))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2301)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.30.1)
