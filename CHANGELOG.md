...
- Bump CLI from v2.5.2 to v2.34.1 ([#67](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/67))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2341)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.34.1)
