...
- Bump CLI from v2.5.2 to v2.51.0 ([#99](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/99))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2510)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.51.0)
