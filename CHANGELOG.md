...
- Bump CLI from v2.5.2 to v2.42.2 ([#86](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/86))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2422)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.42.2)
