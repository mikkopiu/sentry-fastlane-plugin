...
- Bump CLI from v2.5.2 to v2.32.1 ([#63](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/63))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2321)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.32.1)
