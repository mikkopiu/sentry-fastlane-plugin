...
- Bump CLI from v2.5.2 to v2.29.1 ([#55](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/55))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2291)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.29.1)
