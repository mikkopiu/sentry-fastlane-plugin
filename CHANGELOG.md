...
- Bump CLI from v2.5.2 to v2.26.0 ([#50](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/50))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2260)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.26.0)
