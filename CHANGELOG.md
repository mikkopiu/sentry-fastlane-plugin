...
- Bump CLI from v2.5.2 to v2.22.3 ([#42](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/42))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2223)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.22.3)
