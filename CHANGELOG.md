...
- Bump CLI from v2.5.2 to v3.4.0 ([#127](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/127))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#340)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.4.0)
