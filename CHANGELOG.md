...
- Bump CLI from v2.5.2 to v2.52.0 ([#101](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/101))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2520)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.52.0)
