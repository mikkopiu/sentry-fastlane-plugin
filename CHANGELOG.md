...
- Bump CLI from v2.5.2 to v2.21.3 ([#38](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/38))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2213)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.21.3)
