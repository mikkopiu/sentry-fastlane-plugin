...
- Bump CLI from v2.5.2 to v3.3.5 ([#126](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/126))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#335)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.3.5)
