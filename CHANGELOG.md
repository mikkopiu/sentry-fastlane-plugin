...
- Bump CLI from v2.5.2 to v2.32.2 ([#64](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/64))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2322)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.32.2)
