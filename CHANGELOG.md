...
- Bump CLI from v2.5.2 to v2.58.1 ([#109](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/109))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2581)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.58.1)
