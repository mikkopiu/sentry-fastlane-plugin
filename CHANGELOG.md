...
- Bump CLI from v2.5.2 to v3.6.1 ([#134](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/134))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#361)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.6.1)
