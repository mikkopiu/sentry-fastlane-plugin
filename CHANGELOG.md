...
- Bump CLI from v2.5.2 to v2.56.0 ([#105](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/105))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2560)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.56.0)
