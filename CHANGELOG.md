...
- Bump CLI from v2.5.2 to v3.6.2 ([#135](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/135))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#362)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...3.6.2)
