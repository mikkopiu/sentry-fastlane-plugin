...
- Bump CLI from v2.5.2 to v2.17.4 ([#20](https://github.com/mikkopiu/sentry-fastlane-plugin/pull/20))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2174)
  - [diff](https://github.com/getsentry/sentry-cli/compare/2.5.2...2.17.4)
